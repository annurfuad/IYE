...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Admin Panel | SIPIRIS</title>
  ...
  <body class="login-page bg-login">
    <div class="login-box">
      <div style="color:#3c8dbc" class="login-logo">
        IYE <b>Indonesian Young Enterpreneurship</b>
      </div><!-- /.login-logo -->
      <?php
      ...
      // jika alert = 1
      // tampilkan pesan Gagal "email atau Password salah, cek kembali email dan Password Anda"
      elseif ($_GET['alert'] == 1) {
